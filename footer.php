...
<div class="row pt-4">
	...
	<div class="col-md-4">
		...
		<ul class="footer-ul">
			...
			<li><a class="text" href="https://correctionterritory.com/blogs">Blogs</a></li>
			<li><a class="text" href="terms-and-conditions.php">Terms & Conditions</a></li>
			<li><a class="text">Sitemap</a></li>
		</ul>
	</div>
	<div class="col-md-4">
		<h4 class="text">CONTACT US</h4>
		<ul class="footer-ul">
			<li style="border-bottom:1px solid #ffffff00"><a class="text">info@correctionterritory.com</a></li>
			<li style="border-bottom:1px solid #ffffff00"><a class="text">+972 523 770 515</a></li>
			<li style="border-bottom:1px solid #ffffff00"><a class="text">Merchavia 2, Tel Aviv, Israel</a></li>
		</ul>
	</div>
</div>	
</div>
...
<div class="jumbotron" style="margin-bottom:0px;background-color: #141414;border-radius:0px;padding: 0.6rem 2rem;">
	<div class="row">
		<div class="offset-md-1 col-md-11">
			<p class="text" style="text-align:center;">Copyright 2024 © Correction Territory</p>
		</div>
	</div>
</div>